...
## [16.10.0](https://github.com/topgrade-rs/topgrade/compare/v16.9.0...v16.10.0) - 2026-03-01
...
- *(workflow)* gate release-plz only to upstream ([#1801](https://github.com/topgrade-rs/topgrade/pull/1801))
- *(deps)* update rust crate toml to v1.0.3 ([#1772](https://github.com/topgrade-rs/topgrade/pull/1772))
- *(deps)* update actions/dependency-review-action action to v4.8.3 ([#1787](https://github.com/topgrade-rs/topgrade/pull/1787))
- *(deps)* update github/codeql-action action to v4.32.4 ([#1788](https://github.com/topgrade-rs/topgrade/pull/1788))
- *(deps)* update actions/attest-build-provenance action to v4 ([#1796](https://github.com/topgrade-rs/topgrade/pull/1796))
- *(deps)* update github artifact actions (major) ([#1800](https://github.com/topgrade-rs/topgrade/pull/1800))
- *(deps)* update pyo3/maturin-action action to v1.50.1 ([#1807](https://github.com/topgrade-rs/topgrade/pull/1807))
- *(pre-commit)* autoupdate ([#1794](https://github.com/topgrade-rs/topgrade/pull/1794))
